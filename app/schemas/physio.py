...
class SleepData(BaseModel):
    ...
    light_sleep_min: Optional[int] = Field(None, ge=0, le=600, description="Time in light sleep (minutes)", )
    waso_min: Optional[int] = Field(None, ge=0, le=480,
                                    description="Wake after sleep onset (minutes awake during the night)", )
    sleep_onset_time: Optional[datetime.time] = Field(None, description="Time of falling asleep (HH:MM)", )
    wake_time: Optional[datetime.time] = Field(None, description="Time of waking up (HH:MM)", )
    awakenings_count: Optional[int] = Field(None, ge=0, le=50, description="Number of awakenings during the night", )
